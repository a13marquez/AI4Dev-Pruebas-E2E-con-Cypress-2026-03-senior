...
## Prompt 4 — Fix Missing Backend Update Verification Test

> **Requirement:** Verify that the candidate's phase is correctly updated in the backend via the PUT /candidate/:id endpoint.
